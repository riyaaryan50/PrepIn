...
export async function createFeedback(params: CreateFeedbackParams) {
   console.log("Inside createFeedback", params); 
  ...
  try {
    ...
    console.log("Error saving feedback in createFeedback:", error);
...
export async function getLatestInterviews(
  ...
  const interviews = await db
    ...
    .get();
     ...
     if (interviews.empty) {
      console.log("No getLatestInterviews found for user:", userId);
      return null;
    }
...
export async function getInterviewsByUserId(
  ...
  const interviews = await db
    ...
    .get();
     ...
     if (interviews.empty) {
      console.log("No getInterviewsByUserId found for user:", userId);
      return null;
    }
